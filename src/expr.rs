...
pub struct AssignExpr {
    pub target: HirId<Expr>,
    pub value: HirId<Expr>,
}

#[derive(Debug, Clone)]
pub struct MemberAccessExpr {
    pub object: HirId<Expr>,
...
pub struct StructInitExpr {
    ...
    pub fields: Vec<(Symbol, HirId<Expr>)>, // 字段名是 Symbol，值是 HIR 表达式
}
...
#[derive(Debug, Clone)]
pub struct CallExpr {
    pub callee: HirId<Expr>,
    pub args: Vec<HirId<Expr>>,
}
